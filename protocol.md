...
> [!NOTE]
> **For this part, you MUST create a new .R script that has only three commands: the two read.csv() and the object you want gander to manipulate - to eliminate content 'noise'.**
